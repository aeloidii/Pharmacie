...
import 'newFournisseur.dart';

class fournisseur extends StatefulWidget {
  fournisseur({super.key});

  @override
  State<fournisseur> createState() => fournisseurState();
}

class fournisseurState extends State<fournisseur> {
                ...
                child: SafeArea(
                  child: SingleChildScrollView(
                    ...
                    child: Column(
                      crossAxisAlignment: CrossAxisAlignment.start,
                      children: [
                        Header('Fournisseurs', 'Ajout Fournisseur'),
                        SizedBox(
                          height: 60,
                        ),
                        PrimaryText(
                        ...
                        (!Responsive.isDesktop(context))
                            ...
                            children: [
                                ...
                                child: GestureDetector(
                                  onTap: () {
                                    ...
                                    Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => newFournisseur(),
                                      ),
                                    );
                              ...
                              PrimaryText(
                                text: 'LISTE DES FOURNISSEURS DE LA ${EntrpNom.toUpperCase()}', size: 18, fontWeight: FontWeight.w800, color: AppColors.them,),
                              SizedBox(
                                height: 20,
                              ),
                              Column(
                                ...
                                children: [
                                  SizedBox(
                                    ...
                                    child: StreamBuilder<QuerySnapshot>(
                                        stream: FirebaseFirestore.instance.collection('Fournisseurs').orderBy('dateAjout', descending: true).snapshots(),
                                        builder: (BuildContext context, AsyncSnapshot<QuerySnapshot> snapshot) {
                                          ...
                                          if (snapshot.hasData) {
                                            List<DataRow>? rows = snapshot.data?.docs.where((doc) {
                                              ...
                                              // return routeArgs['id_EtrpAddBy'] == id_entr; // skip rows that don't match the condition
                                            }).map((doc) {
                                              var routeArgs = doc.data() as Map;
                                                                ...
                                                                return AlertDialog(
                                                                  ...
                                                                  actions: [
                                                                    ...
                                                                    TextButton(
                                                                      ...
                                                                      onPressed: () {
                                                                        // FirebaseFirestore.instance.collection('Fournisseurs').doc(doc.id).delete();
                                                                        FirebaseFirestore.instance.collection('Fournisseurs').doc(doc.id).update({
                                                                          "state": "deactivated",
                                                                        });
                                                                        Navigator.of(context).pop();
                                                                      },
