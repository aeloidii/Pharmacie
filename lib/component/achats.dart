...
/*generate dmnd PDF*/
  ...
  Future<void> _ajouterAchatFirestore() async { // STOCKER DANS FACTURE AVEC LE MEME ID DE LA COMMANDE
    ...
    await createHistory( id_entr,  id_user,  DateFormat('yyyy-MM-dd   HH:mm').format(DateTime.now()),  "Achat d'article de réf : ${referenceArticle}, Qtte: ${_QuantitTextController.text}, TTC:  ${_SousTTCTextController.text}  ");
...
//                             ),
                            ...
                            firebaseUIButton(
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                  SnackBar(content: Text("Achat enregistré avec succès"),backgroundColor:AppColors.them,showCloseIcon: true,)
                              );
                              // Navigator.push(
                              //   context,
                              //   MaterialPageRoute(
                        ...
                        Center(
                          child: PrimaryText(
                            text: 'LISTE DES ACHATS DE  ${EntrpNom.toUpperCase()}', size: 18, fontWeight: FontWeight.w800, color: AppColors.them,),
                        ),
                        SizedBox(
                          height: 20,
                        ),
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: StreamBuilder<QuerySnapshot>(
                                  stream: FirebaseFirestore.instance.collection('achats').orderBy('dateAjout', descending: true).snapshots(),
                                    ...
                                    if (snapshot.hasData) {
                                            ...
                                            DataCell(Row(mainAxisAlignment: MainAxisAlignment.center,
                                              children: [
                                                ...
                                                IconButton(
                                                    ...
                                                    icon: Icon(Icons.delete, color: Colors.red),
                                                    onPressed: () async {
                                                      await FirebaseFirestore.instance.collection('achats').doc(doc.id).delete();
                                                ...
                                                if (snapshot.hasData) {
                                                  ...
                                                  if (snapshot.data!.exists) {
                                                    ...
                                                    return Text(addBy ?? 'default value');
                                                     ...
                                                     return Text('Via Bon de Commande');
                                                  }
                                      ...
                                      return PaginatedDataTable(
                                        columns: const [
                                          ...
                                          DataColumn(label: Center(child: Text("Réference (Article / BC)"))),
