...
import 'editBC.dart';
import 'editDevis.dart';

class devis extends StatefulWidget {
  devis({super.key});

  @override
  State<devis> createState() => devisState();
}

class devisState extends State<devis> {
...
/*generate dmnd PDF*/
  ...
  final _tableHeadersDevis= ['Réference', 'Article','Quantité','PU(DH)','Taxe(%)','HT(DH)','TTC(DH)'];
  List<List<String>> _tableDataDevis = [
            ...
            children: [
              ...
              pw.Row(
                  ...
                  children: [
                    ...
                    // pw.Text(_DateDeCommandeTextController.text.substring(0,10),style: pw.TextStyle(fontSize: 10),),
              ...
              pw.Text("Devis N° $id_commande",style: pw.TextStyle(fontSize: 16),),
              // Add the table of products to the PDF
              pw.SizedBox(height: 10),
              pw.Table.fromTextArray(
                headers: _tableHeadersDevis,
                data: _tableDataDevis,
  ...
  Future<void> _savePdfToFirebaseStorage() async {
    ...
    final fileName = 'Devis-${DateTime.now().toString()}.pdf';
...
// cette fois ci on envoie au client donc une page deja des client( meme que fournisseur)
                                      ...
                                      child: GestureDetector(
                                        ...
                                        onTap: () async {
                                          ...
                                          try {
                                            ...
                                            await verifierStock(referenceArticle,_QuantitTextController.text,context);
...
//Table temporaire
                        ...
                        Center(
                          child: PrimaryText(
                            text: 'LISTE DES DEVIS DE  ${EntrpNom.toUpperCase()}', size: 18, fontWeight: FontWeight.w800, color: AppColors.them,),
                        ),
                        SizedBox(
                          height: 20,
                        ),
                          ...
                          children: [
                            SizedBox(
                              ...
                              child: StreamBuilder<QuerySnapshot>(
                                  stream: FirebaseFirestore.instance.collection('devis').orderBy('dateAjout', descending: true).snapshots(),
                                    ...
                                    if (snapshot.hasData) {
                                      List<DataRow>? rows = snapshot.data?.docs.where((doc) {
                                        ...
                                        return DataRow(
                                          cells: [
                                                ...
                                                IconButton(
                                                    ...
                                                    onPressed: () {
                                                      Navigator.push(
                                                        context,
                                                        MaterialPageRoute(
                                                          builder: (context) => editDevis(docId: routeArgs['id_devis'],),
                                                        ),
                                                      );
                                                    }),
                                                IconButton(
                                            ...
                                            DataCell(Text(routeArgs['id_devis'] ?? 'default value')),
                                      ...
                                      return PaginatedDataTable(
                                        columns: const [
                                          ...
                                          DataColumn(label: Center(child: Text("Id Devis"))),
