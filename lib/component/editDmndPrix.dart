...
class editDmndPrix extends StatefulWidget {
  String docId;
  editDmndPrix({super.key, required this.docId});

  @override
  State<editDmndPrix> createState() => editDmndPrixState();
}

class editDmndPrixState extends State<editDmndPrix> {
        ...
        build: (pw.Context context) {
          return pw.Column(
            ...
            children: [
              ...
              pw.SizedBox(height: 10),
              whichDoc=="Bon de Commande" ? pw.Column(
          mainAxisAlignment: pw.MainAxisAlignment.end,
          children: [
          pw.Row(
          mainAxisAlignment: pw.MainAxisAlignment.end,
...
String stateBC= 'Non reçue';
  ...
  Future<void> _saveDownloadUrlToFirestore() async {
    ...
    async {
      ...
      await _savePdfToFirebaseStorage("Demande de Prix");
      firebaseFiretore
          .collection(
          "dmndPrix")
          .doc(widget.docId)
      ...
      ListArticleInfoToAdd.add(id_article);
        ...
        await FirebaseFirestore.instance.collection('dmndPrix').doc(widget.docId)
  ...
  Future<void> _createBonCommandeToFirestore() async {
    setState(() {
      _isLoadingV = true;
    });
    await _firestore
                            ...
                            Row(
                              ...
                              children: [
                                ...
                                SizedBox(
                                  width:150,
                                  child:  Stack(
                                    children: [_isLoadingV ? Center(
                                      child: Loading(),
                                    ):
                                      firebaseUIButton(
                                          context, "VALIDER ", ()async {
                                        // await _generateInvoice();
                                        // await _print();
await _createBonCommandeToFirestore();

setState(() {
  state="Validée";
});
ScaffoldMessenger.of(context).showSnackBar(
    SnackBar(content: Text("Enregistrement de validation avec succès"),backgroundColor:AppColors.them,showCloseIcon: true,));                          // _desigFournTextController.text="";
                                      }, AppColors.btn, AppColors.them),
                                      Positioned(
                                        bottom: 30,
                                        right: 10,
